...
check('Título del navegador v46',html.includes('<title>Hoshin Workshop v46 · Indicadores complementarios legibles</title>'));
check('Meta de versión v46',html.includes('<meta name="application-version" content="v46">'));
check('Sello visible v46',html.includes('Versión v46 · Indicadores complementarios legibles'));
check('Índice lateral v46',html.includes('Hoshin Workshop · v46'));
...
check('Resultados complementarios resaltados',html.includes('.report-objectives + .report-grid .report-block>p{')&&html.includes('font-size:18px')&&html.includes('font-weight:900'));
check('Resaltado limitado a la línea de resultado',html.includes('.report-objectives + .report-grid .report-block>p')&&!html.includes('.report-objectives + .report-grid .report-block>small{'));
