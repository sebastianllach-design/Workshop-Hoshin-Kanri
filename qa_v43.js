...
check('Título del navegador v43',html.includes('<title>Hoshin Workshop v43 · Logo Comercial Andina optimizado</title>'));
check('Meta de versión v43',html.includes('<meta name="application-version" content="v43">'));
check('Sello visible v43',html.includes('Versión v43 · Logo Comercial Andina optimizado'));
check('Índice lateral v43',html.includes('Hoshin Workshop · v43'));
