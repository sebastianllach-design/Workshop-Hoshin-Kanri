...
check('Título del navegador v49',html.includes('<title>Hoshin Workshop v49 · Lecturas y síntesis ejecutiva</title>'));
check('Meta de versión v49',html.includes('<meta name="application-version" content="v49">'));
check('Sello visible v49',html.includes('Versión v49 · Lecturas y síntesis ejecutiva'));
check('Índice lateral v49',html.includes('Hoshin Workshop · v49'));
