...
check('Título del navegador v44',html.includes('<title>Hoshin Workshop v44 · Score Final jerarquizado</title>'));
check('Meta de versión v44',html.includes('<meta name="application-version" content="v44">'));
check('Sello visible v44',html.includes('Versión v44 · Score Final jerarquizado'));
check('Índice lateral v44',html.includes('Hoshin Workshop · v44'));
