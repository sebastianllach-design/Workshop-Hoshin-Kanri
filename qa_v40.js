...
check('Título del navegador v40',html.includes('<title>Hoshin Workshop v40 · ERIC por arrastre</title>'));
check('Meta de versión v40',html.includes('<meta name="application-version" content="v40">'));
check('Sello visible v40',html.includes('Versión v40 · ERIC por arrastre'));
check('Índice lateral v40',html.includes('Hoshin Workshop · v40'));
