...
check('Título del navegador v42',html.includes('<title>Hoshin Workshop v42 · Identidad Comercial Andina</title>'));
check('Meta de versión v42',html.includes('<meta name="application-version" content="v42">'));
check('Sello visible v42',html.includes('Versión v42 · Identidad Comercial Andina'));
check('Índice lateral v42',html.includes('Hoshin Workshop · v42'));
check('Clave histórica de persistencia',html.includes("const KEY='hoshin_v31_internal'"));
check('Archivo de logo disponible',fs.existsSync('comercial-andina-logo.png'));
check('Logo incluido antes de Comercial Andina en Hoja 1',html.includes('<div class="ca-logo"><img src="./comercial-andina-logo.png" alt="Logo de Comercial Andina"></div><div><span class="ca-name">COMERCIAL ANDINA</span>'));
check('Logo incluido en esquina superior izquierda de Hoja 4',html.includes('.exec-report:before')&&html.includes('url("./comercial-andina-logo.png")')&&html.includes('left:21px;top:21px'));
